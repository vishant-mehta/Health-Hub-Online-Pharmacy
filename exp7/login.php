...
<head>
              ...
              if(isset($_POST['submit'])) {
                if($emailErr != '' or $passerr != '') {
                    ...
                    if (mysqli_num_rows($result) == 0){
                      ...
                      mysqli_close($db);
                      header("location:http://localhost/miniproject/exp7/register.php"); //signup page ridirection
                      }
                      else{
      ...
      New customer? <a href= "https://localhost/miniproject/exp7/register.php">Register here.
      <br><br>
			</form></div></div>
		</font>
</body>
